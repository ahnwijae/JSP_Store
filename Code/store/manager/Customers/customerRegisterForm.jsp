...
<div class="form-structor">
  <div class="signup">
    ...
    <div class="form-holder">
      ...
      <input type="password" class="input" placeholder="passwd" name="passwd" id="passwd"/>
      <input type="text" class="input" placeholder="name" name="name" id="name"/>
      <input type="text" class="input" placeholder="address" name="address" id="address"/>
      <input type="text" class="input" placeholder="tel" name="tel" id="tel"/>
